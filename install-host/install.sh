...
install_vuls() {
	...
	git clone https://github.com/Normation/go-cve-dictionary.git;
	cd $GOPATH/src/github.com/vulsio/go-cve-dictionary;
  git checkout rudder_20231114;
	make install;
	...
	mkdir -p $GOPATH/src/github.com/vulsio;
	cd $GOPATH/src/github.com/vulsio;
	git clone https://github.com/Normation/goval-dictionary.git;
  ...
  git checkout rudder_20231114;
	...
	mkdir -p $GOPATH/src/github.com/vulsio;
	cd $GOPATH/src/github.com/vulsio;
	git clone https://github.com/Normation/gost.git;
	cd gost;
  git checkout rudder_20231114;
	make install;
...
#	#ln -s $GOPATH/src/github.com/vulsio/go-cti/go-cti.sqlite3 $HOME/go-cti.sqlite3;
	...
	git clone https://github.com/normation/vuls.git;
	cd vuls;
  git checkout rudder_20231114;
	make install;
