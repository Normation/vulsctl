...
case "$target" in
	...
	--amazon) 
		...
		;;
	--debian) 
		goval-dictionary fetch-debian -dbtype=postgres -dbpath="postgres://vuls:${DBPASS}@127.0.0.1/ovaldict" ${@} 8 9 10
		;;
	--ubuntu) 
	...
	--sles)
		...
		;;
	--alpine) 
		goval-dictionary fetch-alpine -dbtype=postgres -dbpath="postgres://vuls:${DBPASS}@127.0.0.1/ovaldict" ${@} 3.3 3.4 3.5 3.6 3.7 3.8 3.9 3.10
		;;
